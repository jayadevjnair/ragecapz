...
const projects = [
  ...
  { id: 15, title: 'V2V Communication Protocol', tech: 'DSRC/C-V2X + OBU', category: 'IoT', img: '/vehicle to vehicle communicatiion protocol.png', desc: 'A vehicle-to-vehicle communication protocol for cooperative collision warning to prevent accidents.' },
  { id: 16, title: 'RFID Ignition Control', tech: 'Microcontroller + RFID Reader', category: 'Embedded', img: '/rfid vehicle project.png', desc: 'A keyless access system that allows only authorized users with a valid RFID tag to start a vehicle.' },
  { id: 17, title: 'Robotic Exoskeleton', tech: 'ESP32 + EMG + IMU', category: 'Robotics', img: '/WhatsApp Image 2026-09-21 at 3.16.25 PM.jpeg', desc: 'An assistive exoskeleton frame designed to help in rehabilitation and support muscle strength.' },
  { id: 18, title: 'Floor Cleaning Robot', tech: 'ESP32 + Motor Driver', category: 'Robotics', img: '/WhatsApp Image 2026-09-21 at 3.18.01 PM.jpeg', desc: 'A wireless floor cleaning robot for homes and offices that features sweeping, mopping, and water spraying.' }
];
